    ...
    (function () {
      ...
      return {
        init: function (c) {
          ...
          c.alphabetical =
            typeof c.alphabetical !== "undefined" ? c.alphabetical : false;
          c.theme = typeof c.theme !== "undefined" ? c.theme : "light";
          c.hideChannels =
            typeof c.hideChannels !== "undefined" ? c.hideChannels : false;
          c.showAllUsers =
            typeof c.showAllUsers !== "undefined" ? c.showAllUsers : false;
          c.allUsersDefaultState =
            typeof c.allUsersDefaultState !== "undefined"
              ? c.allUsersDefaultState
              : true;
        ...
        render: function () {
          ...
          function d() {
            ...
            $("head").append(
              '<link rel="stylesheet" href="https://raw.githubusercontent.com/CyrusCore/discord-widget/master/' +
                k +
                '" type="text/css" />',
            );
            var h =
              "https://discordapp.com/api/servers/" + b.serverId + "/embed.json";
            ...
            function j(y, n) {
              ...
              if (n.title !== false) {
                z.innerHTML =
                  '<div class="discord-title"><h3>' + n.title + "</h3></div>" + A;
                l = $(".discord-tree")[0];
              } else {
                z.innerHTML = A;
                l = $(".discord-tree")[0];
              ...
              if (n.showAllUsers) {
                ...
                for (var t = 0; t < y.members.length; t++) {
                  if (
                    !y.members[t].channel_id ||
                    $.inArray(y.members[t].channel_id, o) >= 0
                  ) {
